...
<body>
    ...
    <div class="Conteiner-Registro">
            ...
            <div class="input-nombre">
                <div class="form-control">
                    <input type="text" required name="Numero_Cuenta">
                    <label class="inp-registro">
            ...
            <div class="input-nombre">
                <div class="form-control">
                    ...
                    <label class="inp-registro">
                        ...
                        <div class="input-nombre">
                <div class="form-control">
                    <input type="password" id="Confirmar_Contraseña" required name="Confirmar_Contraseña">
                    <label class="inp-registro">
                ...
                <div id="mensaejeError" style="color: red;"></div>
            </div>
                <h2 class="decorated">
               <button class="btn" name="registro">Registrar</button>
            </h2>
            </div>
            </form>
    </div>
    ...
    <script>
        document.getElementById("Confirmar_Contraseña").addEventListener("input", function(){
            ...
            let mensajeError = document.getElementById("mensaejeError");
